...
class SVMModelTrainer:
    def __init__(self, dataset_name, root_dir):
        ...
        self.model_dir = os.path.join(root_dir, 'models', 'num', dataset_name, 'svm')
        ...
        # Specify the model parameters for SVM
        svm_params = {
            'C': 1.0,
            'kernel': 'rbf',
            'random_state': 42
        ...
        self.config = NumModelConfig(model_type='svm', dataset=dataset_name, model_params=svm_params)
    ...
    def train_models(self):
        """Main method to train and save SVM models for each number."""
...
def main():
    ...
    for dataset in datasets:
        trainer = SVMModelTrainer(dataset_name=dataset, root_dir=root_dir)
