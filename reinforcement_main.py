...
def run_dqn(data, state_size, action_size, episodes=100, batch_size=45, max_steps=33):
...
def run_policy_gradient(data, state_size, action_size, episodes=100, batch_size=45):
...
def run_actor_critic(data, state_size, action_size, episodes=100, batch_size=45):
...
def run_ppo(data, state_size, action_size, episodes=100, batch_size=45):
