...
class DecisionTreeModelTrainer:
    def __init__(self, dataset_name, root_dir):
        ...
        self.model_dir = os.path.join(root_dir, 'models', 'num', dataset_name, 'decision_tree')
        ...
        # Specify the model parameters for Decision Tree
        dt_params = {
            'criterion': 'gini',
            'max_depth': None,
            'random_state': 42
        ...
        self.config = NumModelConfig(model_type='decision_tree', dataset=dataset_name, model_params=dt_params)
    ...
    def train_and_save_model(self, model_name, model_params, target_column):
        """Trains the Decision Tree model and saves it to a file."""
        ...
        model = DecisionTreeClassifier(**model_params_copy)
    ...
    def train_models(self):
        """Main method to train and save Decision Tree models for each number."""
...
def main():
    ...
    for dataset in datasets:
        trainer = DecisionTreeModelTrainer(dataset_name=dataset, root_dir=root_dir)
