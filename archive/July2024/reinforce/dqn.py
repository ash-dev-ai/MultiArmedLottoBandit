...
class DQNModel:
    def __init__(self, state_size, action_size, number_type, learning_rate=0.001, gamma=0.95, epsilon=1.0, epsilon_min=0.01, epsilon_decay=0.995):
    ...
    def train(self, episodes, data, batch_size=32, max_steps=100):
        ...
        for episode in range(episodes):
            ...
            while not done and step < max_steps:
                ...
                self.remember(state, action, reward, next_state_full, done)
    ...
    def take_action(self, step, action, data):
        ...
        next_state = data.iloc[next_index][['num1', 'num2', 'num3', 'num4', 'num5', 'numA']].values  # Use only relevant columns
...
if __name__ == "__main__":
    ...
    dqn = DQNModel(state_size, action_size, number_type)
