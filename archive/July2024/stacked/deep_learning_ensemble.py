...
class DeepLearningEnsemble:
    ...
    def prepare_data(self, data):
        features = data[['num1', 'num2', 'num3', 'num4', 'num5', 'numA', 'numSum', 'totalSum', 'day']].copy()
        features['date'] = pd.to_datetime(data['date']).astype('int64') // 10**9  # Convert date to numerical value
